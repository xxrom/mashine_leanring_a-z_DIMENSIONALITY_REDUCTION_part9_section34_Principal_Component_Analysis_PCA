# PCA Principal Component Analysis unsupervised model
# unsupervised = алгоритм не зависит от выходного параметра y_test
...
# мы знаем характериситики вина и мы знаем какое вино какой человек пьет
# поэтому новое вино мы сразу будем знать кому лучше рекомендовать
# так как по данным характеристикам вина сразу поймем кто его будет пить
...
# 1 тут говорит о том, что реальный пользователь в 0 группе, а показал 1
# точность модели 35/36 = 97% на тестовых данных
